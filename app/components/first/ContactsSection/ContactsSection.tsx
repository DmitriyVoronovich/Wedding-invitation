...
import img from "@accets/first/image1.png";
import svg from '@accets/first/svgSection/heard_small.svg';
import inst from '@accets/first/svgSection/inst.svg';
import tel from '@accets/first/svgSection/tel.svg';
