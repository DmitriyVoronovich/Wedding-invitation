            ...
            <div className={s.container}>
                <div className={s.section_wrapper}>
                    ...
                    <div className={s.text_wrapper}>
                        ...
                        <p className={s.text}>Этот день, наполненный особой святыней и глубоким значением, будет одним
                        ...
                        <p className={s.text}>P.S.: Отличной альтернативой цветам может стать бутылочка алкогольного напитка, небольшая упаковка зернового кофе или вкусного чая. :)</p>
                    </div>
                </div>
            </div>
        </section>
